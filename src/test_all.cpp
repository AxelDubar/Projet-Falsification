...
void computeFeatures(Bloc &bloc){
	...
	bloc.features.push_back(result[0][0]);
	bloc.features.push_back(result[0][1]);
	bloc.features.push_back(result[1][0]);
	bloc.features.push_back(resultR[0][0]);
	bloc.features.push_back(resultG[0][0]);
	bloc.features.push_back(resultB[0][0]);
...
int main(int argc, char* argv[])
{
	...
	double T1=0.0014;
	int T2=2*N,Ts=N+2,Tn=2;
    char outputName[100],inputName[100];
